...
class Hand_Craftor_visual():
    def __init__(self):
        ...
        self.pose_dir = '/newdisk/AVEC2018/downloaded_dataset/hand_crafted_features/pose.csv'
        self.au_dir = '/newdisk/AVEC2018/downloaded_dataset/hand_crafted_features/FAUs.csv'
        self.face_dir = '/newdisk/AVEC2018/downloaded_dataset/hand_crafted_features/face.csv'
        self.head_dir = '/newdisk/AVEC2018/downloaded_dataset/hand_crafted_features/head.csv'
